...
struct SplashScreenView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .onChange(of: coordinator.shouldRestart) { _, shouldRestart in
                if shouldRestart {
                    print("[SplashScreenView] 🔄 Restart requested - resetting to splash screen")
                    resetToSplash()
                }
            }
        }
    ...
    private func resetToSplash() {
        ...
        // Small delay to ensure UI resets, then restart the flow
